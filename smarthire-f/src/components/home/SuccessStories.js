	...
	return (
		<>
			...
			<section className="py-16 md:py-24 px-4 md:px-6 bg-white">
				<div className="max-w-7xl mx-auto bg-emerald-600 rounded-3xl p-12 md:p-16 text-center">
					<h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
						Ready to Write Your Success Story?
					</h2>
					<p className="text-xl text-emerald-50 mb-8">
						Join thousands of professionals who transformed their careers with SmartHire
					</p>
					<Link
						href="/signup"
						className="inline-block bg-white text-emerald-600 hover:bg-gray-100 font-bold py-4 px-10 rounded-full transition-colors duration-300"
					>
						Get Started Free
					</Link>
				</div>
